 ...
 *     "views_data" = "Drupal\d8_customer\Entity\CustomerViewsData",
 *
 *     "form" = {
 *       "default" = "Drupal\d8_customer\Form\CustomerForm",
 *       "add" = "Drupal\d8_customer\Form\CustomerForm",
 *       "edit" = "Drupal\d8_customer\Form\CustomerForm",
 *       "delete" = "Drupal\d8_customer\Form\CustomerDeleteForm",
 *     },
 *     "route_provider" = {
 *       "html" = "Drupal\d8_customer\CustomerHtmlRouteProvider",
 *     },
 *     "access" = "Drupal\d8_customer\CustomerAccessControlHandler",
 *   },
 *   base_table = "customer",
 *   translatable = FALSE,
